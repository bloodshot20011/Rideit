export const FAQS_DATA = [
  ...
  },
  {
    ...
    answer: "To rent a vehicle, customers will need a valid Indian Driving License (appropriate for the vehicle category) and a government-issued photo ID (Aadhaar Card / Voter ID)."
  },
  {
    question: "Where in Shivpuri will vehicle pickup points be located?",
    answer: "We are establishing initial pickup locations around major hubs in Shivpuri, including Madhav Chowk, Jhansi Road, AB Road, and near the Bus Stand."
  }
];
